...
The **sampling period** $T_s$ (units: :unit[seconds,sample]) is the interval between consecutive samples of a signal. Its reciprocal $f_s = 1 / T_s$ (units: :unit[samples,second], hertz) is the **sample rate**.
:::
