...
:::figure
:figure![A 2 Hz sine wave over one second with period annotation](./assets/fig-period-2hz.png)

:figure![A 4 Hz sine wave over one second with period annotation](./assets/fig-period-4hz.png)
...
:audio[220 Hz sine](./assets/audio-sine-220.wav) :figure![220 Hz sine waveform](./assets/fig-sine-220.png)

$\sin(2\pi \cdot 330 \, t)$ — E4, 330 Hz
:audio[330 Hz sine](./assets/audio-sine-330.wav) :figure![330 Hz sine waveform](./assets/fig-sine-330.png)

$\sin(2\pi \cdot 440 \, t)$ — A4, 440 Hz
:audio[440 Hz sine](./assets/audio-sine-440.wav) :figure![440 Hz sine waveform](./assets/fig-sine-440.png)
...
:audio[220 Hz sine, amplitude 0.5](./assets/audio-sine-amp-0p5.wav) :figure![Waveform at amplitude 0.5](./assets/fig-sine-amp-0p5.png)

$0.05 \sin(2\pi \cdot 220 \, t)$
:audio[220 Hz sine, amplitude 0.05](./assets/audio-sine-amp-0p05.wav) :figure![Waveform at amplitude 0.05](./assets/fig-sine-amp-0p05.png)

$0.005 \sin(2\pi \cdot 220 \, t)$
:audio[220 Hz sine, amplitude 0.005](./assets/audio-sine-amp-0p005.wav) :figure![Waveform at amplitude 0.005](./assets/fig-sine-amp-0p005.png)
...
:audio[Phase = 0](./assets/audio-sine-phase-0.wav) :figure![Waveform at phase 0](./assets/fig-sine-phase-0.png)

$\sin(2\pi \cdot 220 \, t + \pi/2)$
:audio[Phase = pi/2](./assets/audio-sine-phase-1.wav) :figure![Waveform at phase pi/2](./assets/fig-sine-phase-1.png)

$\sin(2\pi \cdot 220 \, t + \pi)$
:audio[Phase = pi](./assets/audio-sine-phase-2.wav) :figure![Waveform at phase pi](./assets/fig-sine-phase-2.png)
...
:::figure
:audio[Random f0, example 1](./assets/audio-additive-f0-0.wav) Random $f_0$, example 1

:audio[Random f0, example 2](./assets/audio-additive-f0-1.wav) Random $f_0$, example 2

:audio[Random f0, example 3](./assets/audio-additive-f0-2.wav) Random $f_0$, example 3

:audio[Random f0, example 4](./assets/audio-additive-f0-3.wav) Random $f_0$, example 4
...
:::figure
:audio[Random timbre 1](./assets/audio-additive-timbre-0.wav) Random amplitudes, example 1

:audio[Random timbre 2](./assets/audio-additive-timbre-1.wav) Random amplitudes, example 2

:audio[Random timbre 3](./assets/audio-additive-timbre-2.wav) Random amplitudes, example 3

:audio[Random timbre 4](./assets/audio-additive-timbre-3.wav) Random amplitudes, example 4
...
:::figure
:audio[Random phase 1](./assets/audio-additive-phase-0.wav) Random phases, example 1

:audio[Random phase 2](./assets/audio-additive-phase-1.wav) Random phases, example 2

:audio[Random phase 3](./assets/audio-additive-phase-2.wav) Random phases, example 3

:audio[Random phase 4](./assets/audio-additive-phase-3.wav) Random phases, example 4
...
:::figure
:audio[K = 1](./assets/audio-additive-K1.wav) $K = 1$ (pure sine)

:audio[K = 2](./assets/audio-additive-K2.wav) $K = 2$

:audio[K = 4](./assets/audio-additive-K4.wav) $K = 4$

:audio[K = 8](./assets/audio-additive-K8.wav) $K = 8$

:figure![Four waveforms showing K = 1, 2, 4, 8 harmonics summed together](./assets/fig-additive-buildup.png)
...
:::figure
:audio[Sawtooth wave](./assets/audio-sawtooth.wav) Sawtooth, 220 Hz

:audio[Square wave](./assets/audio-square.wav) Square, 220 Hz

:audio[Triangle wave](./assets/audio-triangle.wav) Triangle, 220 Hz

:figure![Sawtooth, square, and triangle waveforms synthesized via additive synthesis with K = 32 harmonics](./assets/fig-basic-waveforms.png)
...
:::figure
:audio[Exact sine wave at 440 Hz](./assets/audio-wt-exact.wav) Exact: $\sin(2\pi \cdot 440\,t)$ via `np.sin`

:audio[Nearest-neighbor wavetable, M = 8](./assets/audio-wt-naive-8.wav) Nearest-neighbor wavetable with $M = 8$
...
:audio[Interpolated wavetable, M = 8](./assets/audio-wt-interp-8.wav) Linear interpolation wavetable with $M = 8$
